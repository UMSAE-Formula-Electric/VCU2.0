...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, BT_SW_BTN_Pin|BT_P2_4_Pin|BT_P2_0_Pin|BT_EAN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PB10 PB13 PB15 PB7 */
  GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_13|GPIO_PIN_15|GPIO_PIN_7;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PD10 PD12 PD0 PD1
                           PD2 PD3 PD4 PD5 */
  GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_12|GPIO_PIN_0|GPIO_PIN_1
  ...
  GPIO_InitStruct.Pin = BT_SW_BTN_Pin|BT_P2_4_Pin|BT_P2_0_Pin|BT_EAN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
